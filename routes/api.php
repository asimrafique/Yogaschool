...
Route::get('/frontend/online-registration-mollie', 'Student\RegistrationController@molliePaymentRegisterOnline');
...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    */
    ...
    Route::delete('/backup/{name}', 'Utility\BackupController@destroy');
    ...
    */
    ...
    Route::get('/exam/report/analysis/pre-requisite', 'Exam\ReportAnalysisController@preRequisite');
    Route::group(['middleware' => ['role:admin']], function () {
        Route::get('/exam/report/analysis/export', 'Exam\ReportAnalysisController@export');
    });
    ...
    */
    ...
    Route::post('/vehicle/report/summary/print', 'Transport\Vehicle\ReportController@printSummaryReport');
    Route::post('/vehicle/report/summary/pdf', 'Transport\Vehicle\ReportController@pdfSummaryReport');
    ...
    */
    ...
    Route::post('/push-notification', 'Communication\PushNotificationController@store');
