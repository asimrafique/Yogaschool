...
class EventRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'audience'             => 'required',
            'title'                => 'required',
            'course_id'            => 'required_if:audience,selected_course|array',
            'batch_id'             => 'required_if:audience,selected_batch|array',
            'employee_category_id' => 'required_if:audience,selected_employee_category|array',
            'department_id'        => 'required_if:audience,selected_department|array'
        ];
    }
