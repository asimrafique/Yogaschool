...
class FrontendController extends Controller
{
    ...
    /**
     * Get online registration batch details
     * @return array
     */
    public function getLocationForBatch($id)
    {
        $details = Batch::where('id', '=', $id)->first();
        $location = $details->getOption('location');
        $course_location = array([
            'id' => $location,
            'name' => $location
        ]);
        return $this->success(compact('course_location'));
    }
}
