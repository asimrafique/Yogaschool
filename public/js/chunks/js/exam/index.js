"use strict";
(self["webpackChunkInstiKit"] = self["webpackChunkInstiKit"] || []).push([["js/exam/index"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/exam/index.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/exam/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getExams: function getExams(page) {
      var _this = this;
      var loader = this.$loading.show();
      ...
      axios.get('/api/exam?page=' + page + url).then(function (response) {
        _this.list = [];
        _this.exams = response;
        _this.exams.data.forEach(function (exam) {
          _this.list.push(exam.name);
        });
        loader.hide();
      })["catch"](function (error) {
        loader.hide();
    ...
    editExam: function editExam(exam) {
      this.$router.push('/exam/' + exam.id + '/edit');
    },
    confirmDelete: function confirmDelete(exam) {
      var _this2 = this;
      return function (dialog) {
        return _this2.deleteExam(exam);
      };
    },
    deleteExam: function deleteExam(exam) {
      var _this3 = this;
      var loader = this.$loading.show();
      axios["delete"]('/api/exam/' + exam.id).then(function (response) {
        toastr.success(response.message);
        _this3.getExams();
        loader.hide();
      })["catch"](function (error) {
    ...
    reorderExam: function reorderExam() {
      var _this5 = this;
      axios.post('/api/exam/reorder', {
        list: this.list
      }).then(function (response) {
        toastr.success(response.message);
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/exam/index.vue?vue&type=template&id=44b88421&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/exam/index.vue?vue&type=template&id=44b88421& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_vm.exams.total && !_vm.showCreatePanel && _vm.hasPermission("create-exam") ? _c("button", {
    directives: [{
      name: "tooltip",
      rawName: "v-tooltip",
  ...
  }, [_vm._v(_vm._s(_vm.trans("exam.add_new_exam")))])]) : _vm._e(), _vm._v(" "), _vm.hasPermission("edit-exam") && _vm.exams.total ? _c("button", {
    directives: [{
      name: "tooltip",
      rawName: "v-tooltip",
    ...
    staticClass: "d-none d-sm-inline"
  }, [_vm._v(_vm._s(_vm.trans("exam.reorder_exam")))])]) : _vm._e(), _vm._v(" "), !_vm.showFilterPanel ? _c("button", {
    staticClass: "btn btn-info btn-sm",
    on: {
      click: function click($event) {
  ...
  }, [_vm._v(_vm._s(_vm.trans("general.filter")))])])])]) : _vm._e()]), _vm._v(" "), _vm.hasPermission("create-exam") ? _c("transition", {
    attrs: {
      name: "fade"
    }
    ...
    staticClass: "card-title"
  }, [_vm._v(_vm._s(_vm.trans("exam.add_new_exam")))]), _vm._v(" "), _c("exam-form", {
    on: {
    ...
    staticClass: "card-body"
  }, [_vm.exams.total ? _c("div", {
    staticClass: "table-responsive"
  }, [_c("table", {
    staticClass: "table table-sm"
  }, [_c("thead", [_c("tr", [_c("th", [_vm._v(_vm._s(_vm.trans("exam.exam_name")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.trans("exam.term")))]), _vm._v(" "), _c("th", [_vm._v(_vm._s(_vm.trans("exam.exam_description")))]), _vm._v(" "), _c("th", {
    staticClass: "table-option"
  }, [_vm._v(_vm._s(_vm.trans("general.action")))])])]), _vm._v(" "), _c("tbody", _vm._l(_vm.exams.data, function (exam) {
    return _c("tr", [_c("td", {
      domProps: {
        textContent: _vm._s(exam.name)
      }
    }), _vm._v(" "), _c("td", [_vm._v("\n                                    " + _vm._s(exam.exam_term_id ? exam.term.name + " (" + exam.term.course_group.name + ")" : "") + "\n                                ")]), _vm._v(" "), _c("td", {
      domProps: {
      ...
      staticClass: "btn-group"
    }, [_vm.hasPermission("edit-exam") ? _c("button", {
      directives: [{
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.trans("exam.edit_exam"),
        expression: "trans('exam.edit_exam')"
      }],
      staticClass: "btn btn-info btn-sm",
      on: {
        click: function click($event) {
    ...
    })]) : _vm._e(), _vm._v(" "), _vm.hasPermission("delete-exam") ? _c("button", {
      directives: [{
        name: "confirm",
        rawName: "v-confirm",
        value: {
        ...
        expression: "{ok: confirmDelete(exam)}"
      }, {
        name: "tooltip",
        rawName: "v-tooltip",
        value: _vm.trans("exam.delete_exam"),
        expression: "trans('exam.delete_exam')"
      }],
      key: exam.id,
  ...
  }), 0)])]) : _vm._e(), _vm._v(" "), !_vm.exams.total ? _c("module-info", {
    attrs: {
      module: "exam",
    ...
    slot: "btn"
  }, [!_vm.showCreatePanel && _vm.hasPermission("create-exam") ? _c("button", {
  ...
  })], 1)])], 1), _vm._v(" "), _vm.hasPermission("edit-exam") && _vm.showReorderModal ? _c("transition", {
    attrs: {
      name: "modal"
    }
  }, [_c("div", {
...
/***/ "./resources/js/views/exam/index.vue":
/*!*******************************************!*\
  !*** ./resources/js/views/exam/index.vue ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_44b88421___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=44b88421& */ "./resources/js/views/exam/index.vue?vue&type=template&id=44b88421&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./resources/js/views/exam/index.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _index_vue_vue_type_template_id_44b88421___WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_44b88421___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/***/ "./resources/js/views/exam/index.vue?vue&type=script&lang=js&":
/*!********************************************************************!*\
  !*** ./resources/js/views/exam/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/exam/index.vue?vue&type=script&lang=js&");
...
/***/ "./resources/js/views/exam/index.vue?vue&type=template&id=44b88421&":
/*!**************************************************************************!*\
  !*** ./resources/js/views/exam/index.vue?vue&type=template&id=44b88421& ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_44b88421___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_44b88421___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_44b88421___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=44b88421& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/exam/index.vue?vue&type=template&id=44b88421&");


/***/ })

}]);
//# sourceMappingURL=index.js.map?id=c9c62680913794a2