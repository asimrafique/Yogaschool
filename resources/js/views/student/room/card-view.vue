        ...
        <div class="page-titles">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3 class="text-themecolor">Room  ({{getSession}})
                        ...
                        <div class="col-md-3 col-12" >
                            <div class="card card-box with-shadow student-card">
                                <div class="card-body">
                                    ...
                                    <div class="student-info" @click="navigateToStudent(room)">
                                        <span class="student-thumb pull-left">
                                            <template v-if="!false">
                                                <img v-if="room_alloted.gender_allotted == 'female'" src="/images/avatar_female_kid.png" class="img-circle">
                                        ...
                                        <p>
                                            <span class="other small text-muted">#{{room_alloted.id}}  ( gender : {{room_alloted.gender_allotted}})   Location :#{{room_alloted.b_location}}</span>
                                             <span class="student-name">{{ room_alloted.name }} </span>
                                            <span class="other small text-muted">Type #{{room_alloted.type_name}} </span>
                                                <span class="other small text-muted">Type #{{room_alloted.building_name}}</span>
    ...
    export default {
        ...
        methods: {
            ...
            getRegistrations(page){
                ...
                axios.get('/api/registration/room?page=' + page + url)
                    .then(response => {
                        ...
                        this.room_alloted=response.room_alloted;
                        loader.hide();
                    })
                    .catch(error => {
                        loader.hide();
