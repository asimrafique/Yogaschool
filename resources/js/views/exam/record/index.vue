                ...
                <div class="card-body p-t-20">
			        <form @submit.prevent="submit" @keydown="recordForm.errors.clear($event.target.name)">
                        ...
                        <div class="row" v-for="(mark,index) in recordForm.marks">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="custom-control custom-checkbox">
                                            <input :disabled="disable_input" type="checkbox" class="custom-control-input" value="1" v-model="mark.is_absent">
                                            <span class="custom-control-label">{{trans('exam.is_absent')}}</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <template v-if="! mark.is_absent">
                            ...
                            <template v-else>
                                <div class="col-12 col-sm-9" v-if="show_comment">
                                    <div class="form-group">
                                        <autosize-textarea :disabled="disable_input" v-model="mark.comment" rows="1" :name="getCommentName(index)" :placeholder="trans('exam.mark_comment')"></autosize-textarea>
                                    </div>
                                </div>
