...
use _PhpScoperaac020b02c46\Composer\CaBundle\CaBundle;
use _PhpScoperaac020b02c46\GuzzleHttp\Client;
use _PhpScoperaac020b02c46\GuzzleHttp\ClientInterface;
use _PhpScoperaac020b02c46\GuzzleHttp\Exception\GuzzleException;
use _PhpScoperaac020b02c46\GuzzleHttp\HandlerStack;
use _PhpScoperaac020b02c46\GuzzleHttp\Psr7\Request;
use _PhpScoperaac020b02c46\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
use Mollie\Api\Exceptions\ApiException;
use _PhpScoperaac020b02c46\Psr\Http\Message\ResponseInterface;
final class Guzzle6And7MollieHttpAdapter implements \Mollie\Api\HttpAdapter\MollieHttpAdapterInterface
{
    ...
    public function __construct(\_PhpScoperaac020b02c46\GuzzleHttp\ClientInterface $httpClient)
    {
    ...
    public static function createDefault()
    {
        ...
        $handlerStack = \_PhpScoperaac020b02c46\GuzzleHttp\HandlerStack::create();
        $handlerStack->push($retryMiddlewareFactory->retry());
        $client = new \_PhpScoperaac020b02c46\GuzzleHttp\Client([\_PhpScoperaac020b02c46\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoperaac020b02c46\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoperaac020b02c46\GuzzleHttp\RequestOptions::TIMEOUT => self::DEFAULT_TIMEOUT, \_PhpScoperaac020b02c46\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::DEFAULT_CONNECT_TIMEOUT, 'handler' => $handlerStack]);
    ...
    {
        $request = new \_PhpScoperaac020b02c46\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoperaac020b02c46\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoperaac020b02c46\Psr\Http\Message\ResponseInterface $response)
    {
    ...
    public function versionString()
    {
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            return "Guzzle/" . \_PhpScoperaac020b02c46\GuzzleHttp\ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            return "Guzzle/" . \_PhpScoperaac020b02c46\GuzzleHttp\ClientInterface::VERSION;
        }
        return null;
    }
}
